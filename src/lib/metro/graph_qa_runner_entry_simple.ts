...
type QACase = { name: string; from: string; to: string; mode: Mode };
...
export function main() {
    ...
    console.log("\nAll simple QA cases passed.");
}

// allow running with: node dist/... if built as CJS/ESM
if (process.env.METRO_QA === "1") {
    main();
}
